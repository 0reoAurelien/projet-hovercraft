...
Nous avons ensuite testé ce signal sur le moteur (avec le régulateur XQ et une batterie 14V), cependant par mauvais choix de fréquence de signal PWM et/ou de consignes de démarrage dans le code, nous n'avons réussi qu'à entendre les beeps provenant du moteur testé.
